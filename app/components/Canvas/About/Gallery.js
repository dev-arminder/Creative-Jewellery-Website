...
export default class Gallery {
  constructor({ element, geometry, index, gl, scene, sizes }) {
    ...
    this.elementsWrapper = element.querySelector(".about__gallery_wrapper");
  ...
  createMedias() {
    this.mediasElements = this.element.querySelectorAll('.about__gallery_media'); // prettier-ignore
